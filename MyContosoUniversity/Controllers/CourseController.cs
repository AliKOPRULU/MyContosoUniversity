    ...
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,Title,Credits,DepartmentID")] Course course)
        {
            ...
            catch (RetryLimitExceededException)
            {
                ...
                ModelState.AddModelError("", "Değişiklikleri kaydedilemiyor.Tekrar deneyin ve sorun devam ederse, sistem yöneticinize başvurun.");
            }
        ...
        {//Bütün bölümleri isim sıralı getiriyor. Dropdown
