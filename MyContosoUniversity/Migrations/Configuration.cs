namespace MyContosoUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyContosoUniversity.DAL.SchoolContext>
    {
        ...
        protected override void Seed(MyContosoUniversity.DAL.SchoolContext context)
        {
            ...
            {//Her iki kontrol iþlemi burada yapýlýyor ona göre ekleniyor.
